...
import static software.amazon.kinesis.connectors.flink.config.AWSConfigConstants.AWS_ROLE_ARN;
import static software.amazon.kinesis.connectors.flink.config.AWSConfigConstants.AWS_ROLE_SESSION_NAME;
...
public class EfoApplication {
	...
	private static SourceFunction<String> createKdsSource(final Properties consumerConfig) {
		...
		consumerConfig.putIfAbsent(EFO_CONSUMER_NAME, "my-flink-efo-consumer");
		consumerConfig.putIfAbsent(AWS_REGION, "YOUR_REGION");
		consumerConfig.putIfAbsent(AWS_CREDENTIALS_PROVIDER, "ASSUME_ROLE");
        consumerConfig.putIfAbsent(AWS_ROLE_ARN, "arn:aws:iam::SOURCE_ACCOUNT_ID:role/KA-Source-Stream-Role");
        consumerConfig.putIfAbsent(AWS_ROLE_SESSION_NAME, "ksassumedrolesession");
	...
	private static SinkFunction<String> createKdsSink(final Properties producerConfig) {
		producerConfig.putIfAbsent(AWS_REGION, "YOUR_REGION");
